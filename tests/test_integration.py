...
class TestIntegration:
    ...
    def test_chaining_operations(self, sample_tree, sample_metadata):
        ...
        p = baltic_bokeh.plotPoints(tree, p=p, metadata_df=metadata, color_column='species')
        ...
        assert text_renderer_count >= points_renderer_count  # Text might not add renderers if no data
    
    def test_error_handling_invalid_files(self):
        """Test error handling with invalid files."""
        with pytest.raises(Exception):  # Baltic should raise an exception for invalid files
